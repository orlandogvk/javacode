...
public class VResgistroTransRed extends JDialog {
    ...
    public VResgistroTransRed(JFrame parent, boolean modal) {
         super(parent,modal);
         crearVentana(); 
    }
    ...
    public void crearVentana(){
     ...
     private void crearEtiquetas(){
        ...
        lblIddedi.setBounds(50,150,100,30);
        pizarra.add(lblIddedi);
        lblIddedi.setVisible(true);
     ...
     public void crearCaja(){
        ...
        txtDed.setBounds(160, 150, 100, 30);
        pizarra.add(txtDed);
        txtDed.setVisible(true);
